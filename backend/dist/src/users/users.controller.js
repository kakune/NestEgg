...
let UsersController = class UsersController {
    ...
    async update(id, updateUserDto, user) {
        return this.usersService.update(id, updateUserDto, this.getAuthContext(user));
    }
    async changePassword(id, changePasswordDto, user) {
        await this.usersService.changePassword(id, changePasswordDto, this.getAuthContext(user));
    }
